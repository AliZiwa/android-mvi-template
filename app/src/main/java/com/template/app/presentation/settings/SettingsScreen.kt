    ...
    LaunchedEffect(Unit) {
        viewModel.effect.collect { effect ->
            when (effect) {
                ...
                is SettingsContract.Effect.NavigateToLogin -> onLogout()
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Settings") },
                navigationIcon = {
                    IconButton(onClick = { viewModel.onEvent(SettingsContract.Event.BackClicked) }) {
        ...
        Column(
            ...
            Button(
                onClick = { viewModel.onEvent(SettingsContract.Event.LogoutClicked) },
